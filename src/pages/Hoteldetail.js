                                ...
                                <Row>
                                    <Col md={9}>
                                        <div className="carousel mt-3" >
                                            <img style={{width:'630px', height:'360px'}}
                                            src="https://d1nabgopwop1kh.cloudfront.net/hotel-asset/30000002000088824_wh_6" alt="#"></img>
                                        </div>
                                        <div className="thumbnail">
                                            <div className="thumbnail-img mt-2">
                                                <img style={{width:'165px', height:'116px'}}
                                                src="https://d1nabgopwop1kh.cloudfront.net/hotel-asset/30000002000076416_t2_7" alt="#" class="img-thumbnail"></img>

                                                <img style={{width:'165px', height:'116px'}}src="https://d1nabgopwop1kh.cloudfront.net/hotel-asset/30000002000088824_t2_6" alt="#" class="img-thumbnail"></img>

                                                <img style={{width:'165px', height:'116px'}}src="https://d1nabgopwop1kh.cloudfront.net/hotel-asset/30000002000121498_t2_7" alt="#" class="img-thumbnail"></img>

                                                <img style={{width:'165px', height:'116px'}}src="https://d1nabgopwop1kh.cloudfront.net/hotel-asset/30000002000076416_t2_7" alt="#" class="img-thumbnail"></img>
                                            </div>
                                        </div>
                                    </Col>

                                    <Col md={3} style={{display:'nowrap', lineHeight:'1.25'}}>
                                        ...
                                        <div className="card" >
                                            <Card style={{backgroundColor:'#e7e7e7', border:'none'}}>
                                        ...
                                        <div className="rate-viewer">
                                            <img style={{width:'83px', height:'14px'}} src= "https://www.tripadvisor.com/img/cdsi/img2/ratings/traveler/3.5-26258-5.svg"/>
